        ...
        <Card sx={{ mb: 15, p: 1, borderRadius: 2, boxShadow: 3 }}>
          <CardContent>
            <Typography paragraph>
              Manage your patients' imaging requests efficiently. Use the options below to view, request, or delete imaging requests as per your requirements.
            </Typography>
          </CardContent>
        </Card>

        {/* Content Section */}
        <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 3,marginLeft: '50px' }}>
          {/* Image */}
          <Box sx={{ flex: 1 }}>
            <img
              src="imagings.jpg"
              alt="Imaging Dashboard Image"
              style={{ width: '330%', height: 'auto' }}
            />
          </Box>

          {/* Cards Section */}
          <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 3, marginLeft: '725px' }}>
            {/* Cards Row 1 */}
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                    ...
                    'You do not have permission to view imagings.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="view-imagings.png" alt="View Imagings Icon" />
                  <Typography
                    variant="h6"
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    ...
                    'You do not have permission to request new imaging.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="request-imaging.png" alt="Request Imaging Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                    '/imaging/delete',
                    Permissions.DeleteImaging,
                    'You do not have permission to delete imaging requests.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="delete-imaging.png" alt="Delete Imaging Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
                  ...
                  <Typography variant="body2" sx={{ fontFamily: 'ABeeZee, sans-serif' }}>
                    Delete existing imaging requests
                  </Typography>
                </CardContent>
              </Card>
            </Box>
