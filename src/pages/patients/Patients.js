        ...
        <Card sx={{ mb: 15, p: 1, borderRadius: 2, boxShadow: 3 }}>
          <CardContent>
            <Typography paragraph>
              Manage and view patient information efficiently. Use the options below to navigate to different patient management functions, such as viewing patient records, adding new patients, or updating existing patient details.
            </Typography>
          </CardContent>
        </Card>
         ...
         <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 3 }}>
          ...
          <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 3, marginLeft: '725px' }}>
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              ...
              >
                <CardContent>
                <OperationIcon src={'search-patients.png'} alt="search-patients-icon" />
                  <Typography
                    variant="h6"
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              ...
              >
                <CardContent>
                <OperationIcon src={'add-patient.png'} alt="add-patient-icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              ...
              >
                <CardContent>
                <OperationIcon src={'update-patient.png'} alt="update-patient-icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
