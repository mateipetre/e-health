...
import EditDiagnosisModal from './UpdateDiagnosisModal'; // Modal component for editing diagnoses

const EditDiagnoses = ({ patientId }) => {
  ...
  useEffect(() => {
    const fetchDiagnoses = async () => {
      try {
        const response = await axios.get(`/patients/66cb68934f5769ec17d174a9/diagnoses`);
