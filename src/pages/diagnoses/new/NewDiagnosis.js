...
const NewDiagnosis = ({ patientId }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(`/patients/66cb68934f5769ec17d174a9/diagnoses`, newDiagnosis);
    ...
    <Box sx={{ padding: '20px', boxSizing: 'border-box', maxWidth: '2100px' }}>
      ...
      <HICSuccessModal
        ...
        onClose={() => {
          ...
          navigate('/diagnoses'); // Redirect after closing the modal
        }}
        title="Success"
        ...
        actions={[
          {
            ...
            onClick: () => navigate('/diagnoses/view'),
            variant: 'contained',
            color: 'primary',
          },
        ]}
