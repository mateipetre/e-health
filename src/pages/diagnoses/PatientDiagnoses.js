          ...
          <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 3, marginLeft: '500px', marginTop: '100px' }}>
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                  `/patients/diagnoses/view/${patientId}`,
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/diagnoses/new/${patientId}`,
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/diagnoses/update/${patientId}`,
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/diagnoses/delete/${patientId}`,
