        ...
        <Card sx={{ mb: 15, p: 1, borderRadius: 2, boxShadow: 3 }}>
          <CardContent>
            <Typography paragraph>
              Manage allergies efficiently. Use the options below to view, add, edit, or delete allergies based on your permissions.
            </Typography>
          </CardContent>
        </Card>
          ...
          <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 3, marginLeft: '400px', marginTop: '100px' }}>
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/allergies/view/${patientId}`,
                    Permissions.ReadAllergies,
                    'You do not have permission to view allergies.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="/view-allergies.png" alt="View Allergies Icon" />
                  <Typography
                    variant="h6"
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/allergies/new/${patientId}`,
              ...
              >
                <CardContent>
                  <OperationIcon src="/add-allergy.png" alt="Add Allergy Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/allergies/update/${patientId}`,
                    Permissions.EditAllergy,
                    'You do not have permission to edit allergies.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="/edit-allergy.png" alt="Edit Allergy Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    `/patients/allergies/delete/${patientId}`,
                    Permissions.DeleteAllergy,
                    'You do not have permission to delete allergies.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="/delete-allergy.png" alt="Delete Allergy Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
