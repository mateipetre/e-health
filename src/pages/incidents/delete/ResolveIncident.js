...
const ResolveIncident = () => {
  ...
  useEffect(() => {
    const fetchIncidents = async () => {
      try {
        const response = await axios.get('/patients/66cb68934f5769ec17d174a9/incidents'); // Adjust patientId as needed
  ...
  const confirmResolve = async () => {
    try {
      await axios.put(`/patients/66cb68934f5769ec17d174a9/incidents/${selectedIncident._id}/resolve`);
