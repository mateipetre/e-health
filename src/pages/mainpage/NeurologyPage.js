...
const NeurologyPage = () => {
  ...
  const conditions = [
    { name: 'Migraine', info: 'Migraines are severe headaches that often come with nausea and sensitivity to light and sound.' },
    { name: 'Epilepsy', info: 'Epilepsy is a neurological disorder marked by recurring seizures. Learn about management and treatments here.' },
        ...
        <Box sx={{ width: '100%', maxWidth: '1200px' }}>
          ...
          <Card sx={{ mb: 4, backgroundColor: pastelBlue, color: '#ffffff', boxShadow: 3 }}>
            <CardContent>
              ...
              <Typography>
                Our mission is to provide students with expert care for neurological conditions through accurate diagnosis,
                effective treatments, and ongoing support.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Typography paragraph>
            On our platform, you can find detailed information about neurological conditions, including symptoms, causes, and
            treatment options. Our specialists are here to assist with your neurological health needs.
          </Typography>
          ...
          <Typography paragraph>
            Treatments for neurological conditions may include medication, lifestyle changes, and specialized therapies. Explore
            these options with our experts for personalized care.
          </Typography>
          ...
          <Typography>
            <Link href="https://www.aan.com/Patients/" target="_blank" rel="noopener" sx={{ color: pastelBlue }}>
              American Academy of Neurology - Patient Information
            </Link>
          </Typography>
          <Typography>
            <Link href="https://www.mayoclinic.org/diseases-conditions/neurological-conditions/symptoms-causes/syc-20350683" target="_blank" rel="noopener" sx={{ color: pastelBlue }}>
              Mayo Clinic - Neurological Conditions Overview
            </Link>
          </Typography>
          <Typography>
            <Link href="https://www.nhs.uk/conditions/neurological-conditions/" target="_blank" rel="noopener" sx={{ color: pastelBlue }}>
              NHS - Neurological Conditions
            </Link>
          </Typography>
        </Box>
