      ...
      >
        ...
        <Card sx={{ mb: 15, p: 1, borderRadius: 2, boxShadow: 3 }}>
          <CardContent>
            <Typography paragraph>
              Manage your patients' care plans efficiently. Use the options below to view, add, edit, or delete care plans as per your requirements.
            </Typography>
          </CardContent>
        </Card>
        ...
        <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 3 }}>
          ...
          <Box sx={{ flex: 1 }}>
            <img
              src="care-plans.jpg"
              alt="Care Plans Image"
              style={{ width: '140%', height: 'auto' }}
            />
          </Box>

          {/* Cards Section */}
          <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', gap: 3, marginLeft: '300px', marginTop: '180px' }}>
            {/* Cards Row 1 */}
            <Box sx={{ display: 'flex', gap: 3 }}>
              ...
              >
                <CardContent>
                  <OperationIcon src="view-care-plans.png" alt="View Care Plans Icon" />
                  <Typography
                    variant="h6"
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    ...
                    'You do not have permission to add care plans.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="add-care-plan.png" alt="Add Care Plan Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              ...
              >
                <CardContent>
                  <OperationIcon src="edit-care-plan.png" alt="Edit Care Plan Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
              ...
              <Card
                onClick={() =>
                  handleCardClick(
                    '/care-plans/delete',
                    Permissions.DeleteCarePlan,
                    'You do not have permission to delete care plans.'
                  )
                }
                sx={{
                  boxShadow: 5,
              ...
              >
                <CardContent>
                  <OperationIcon src="delete-care-plan.png" alt="Delete Care Plan Icon" />
                  <Typography
                    variant="h6"
                    sx={{ mt: 2, fontFamily: 'ABeeZee, sans-serif', fontWeight: 'bold' }}
                  >
