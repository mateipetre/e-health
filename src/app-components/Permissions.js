const Permissions = Object.freeze({
  ...
  ViewDoctorIncidents: 'read:doctor-incidents',
  ViewDoctorIncident: 'read:doctor-incident',
  UpdateDoctorIncident: 'update:doctor-incident',
  ReportDoctorIncident: 'write:doctor-incident',
  ResolveDoctorIncident: 'resolve:doctor-incident',
  ...
  AddNote: 'add:note',
  ViewDoctorNote: 'view:doctor-note',
  ViewDoctorNotes: 'view:doctor-notes',
  EditDoctorNote: 'edit:doctor-note',
  DeleteDoctorNote: 'delete:doctor-note',
